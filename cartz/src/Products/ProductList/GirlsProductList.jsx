...
import { girlsProduct } from "../../Redux/ProductReducer/action";
...
export const GirlsProductList = () => {
  ...
  useEffect(() => {
    ...
    inputRef.current = setTimeout(() => {
      dispatch(girlsProduct(paramObj));
    }, 1000);
  }, [query]);
    ...
    <DIV>
      ...
      {loading ? (
        ...
        <Box textAlign="center" py={35} px={6}>
          ...
          <Box>
            <Link to={"/girls"}><Button style={{marginTop: '30px', backgroundColor: 'black', color: 'white'}}>Explore more</Button></Link>
          </Box>
        </Box>
      )}
    </DIV>
