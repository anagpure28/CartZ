...
export default function Simple() {
  ...
  return (
    ...
    <Container maxW={"7xl"}>
      ...
      >
        ...
        <div className="container">
          ...
          <div style={{width: "90%", margin:"auto",  marginTop: "160px",}}>
            <img src="https://static.vecteezy.com/system/resources/previews/002/461/553/original/buy-1-get-1-free-sale-banner-template-illustration-free-vector.jpg" alt="" />
          </div>
        </div>
        ...
        >
          <Box as={"header"} textAlign={"left"}>
            ...
            <Link style={{color: "blue", textDecoration: "underline"}} to={"#"}>Visit the Store</Link>
            <Text
              color={useColorModeValue("gray.900", "gray.400")}
              fontWeight={400}
              fontSize={"md"}
            >
              Rating | 246 answered questions
            </Text>
            <Text
              color={useColorModeValue("gray.900", "gray.400")}
              fontWeight={400}
          ...
          >
            <Box spacing={{ base: 2, sm: 4 }}>
              ...
              <Text textAlign={"left"} mt={-4} fontWeight={600}>
                Including all Taxes
              </Text>
      ...
      <Box w={"100%"} mt={2}>
        <Image src="https://cdn.w600.comps.canstockphoto.com/discount-for-flat-people-vector-image_csp91298978.jpg" alt="" />
      </Box>
